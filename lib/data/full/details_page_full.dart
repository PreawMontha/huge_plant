...
import 'package:huge_plant/data/full/plant_model_full.dart';

class DetailsPageFull extends StatelessWidget {
  final PlantsFull plant;
  const DetailsPageFull({Key? key, required this.plant}) : super(key: key);
