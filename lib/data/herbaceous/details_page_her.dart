...
import 'package:huge_plant/data/herbaceous/plant_model_her.dart';

class DetailsPageHer extends StatelessWidget {
  final PlantsHer plant;
  const DetailsPageHer({Key? key, required this.plant}) : super(key: key);
