...
import 'package:huge_plant/data/ground/plant_model_ground.dart';

class DetailsPageGround extends StatelessWidget {
  final PlantsGround plant;
  const DetailsPageGround({Key? key, required this.plant}) : super(key: key);
