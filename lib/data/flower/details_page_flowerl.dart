...
import 'package:huge_plant/data/flower/plant_model_flower.dart';

class DetailsPageFlower extends StatelessWidget {
  final PlantsFlower plant;
  const DetailsPageFlower({Key? key, required this.plant}) : super(key: key);
